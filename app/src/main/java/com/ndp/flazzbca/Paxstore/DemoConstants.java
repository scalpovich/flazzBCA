...
public class DemoConstants {
    ...
    public static final String APP_PACKAGENAME_FOR_DEMO_DISPLAY = "com.MobileTicket";
    ...
    public static final String PUSH_RESULT_SP = "sp_push_result";
    ...
    public static final String DOWNLOAD_PARAM_FILE_NAME = "flazz.xml";
}