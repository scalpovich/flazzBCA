        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    downloadResult = StoreSdk.getInstance().paramApi().downloadParamToPath(getApplication().getPackageName(), com.ndp.flazzbca.BuildConfig.VERSION_CODE, saveFilePath);
...
//                businesscode==0, means download successful, if not equal to 0, please check the return message when need.
                Log.i("PR", "Download result = "+ downloadResult);
                Log.i("PR", "Download result = "+ downloadResult.getBusinessCode());
